    ...
    <div class="md:grid md:grid-cols-3 md:gap-6">
        <div class="md:col-span-1">
            <div class="px-4 sm:px-0">
                <h3 class="text-lg font-medium leading-6 text-gray-900">Edit Wakil</h3>
        ...
        <div class="mt-5 md:mt-0 md:col-span-2">
            <form action="<?= base_url('/candidatescontroller/updatewakil/' . $wakil->id_wakil); ?>" method="POST" enctype="multipart/form-data">
                <div class="shadow sm:rounded-md sm:overflow-hidden">
                    <div class="px-4 py-5 bg-white space-y-6 sm:p-6">
                        <div class="grid grid-cols-6 gap-6">
                            <div class="col-span-6">
                                <label for="jabatanpreview" class="block text-sm font-medium text-gray-700">Jabatan</label>
                                <input readonly type="text" name="jabatanpreview" id="jabatanpreview" class="mt-1 focus:outline-none focus:ring-blue-500 focus:border-blue-500 block w-full shadow-sm sm:text-sm border border-gray-300 rounded-md py-2 px-3" value="Wakil">
                            </div>
                        </div>
                        <div class="grid grid-cols-6 gap-6">
                            <div class="col-span-6 sm:col-span-3">
                                <label for="name" class="block text-sm font-medium text-gray-700">Nama</label>
                                <input type="text" name="name" id="name" class="mt-1 focus:outline-none focus:ring-blue-500 focus:border-blue-500 block w-full shadow-sm sm:text-sm border border-gray-300 rounded-md py-2 px-3" value="<?= old('name') ? old('name') : $wakil->name; ?>">
                            ...
                            <div class="col-span-6 sm:col-span-3">
                                ...
                                <select id="class" name="class" class="mt-1 block w-full py-2 px-3 border border-gray-300 bg-white rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm">
                                    <option value="<?= $wakil->id_class; ?>"><?= $wakil->class; ?></option>
                        ...
                        <div>
                            ...
                            <div class="mt-1">
                                <textarea id="visi" name="visi" rows="3" class="h-32 mt-1 focus:outline-none focus:ring-blue-500 focus:border-blue-500 block w-full shadow-sm sm:text-sm border border-gray-300 rounded-md py-2 px-3"><?= old('name') ? old('name') : $wakil->visi; ?></textarea>
                            </div>
                            <div class="text-sm text-red-600">
                        ...
                        <div>
                            ...
                            <div class="mt-1">
                                <textarea id="misi" name="misi" rows="3" class="h-32 mt-1 focus:outline-none focus:ring-blue-500 focus:border-blue-500 block w-full shadow-sm sm:text-sm border border-gray-300 rounded-md py-2 px-3"><?= old('name') ? old('name') : $wakil->misi; ?></textarea>
                            </div>
                            <div class="text-sm text-red-600">
                        ...
                        <div>
                            ...
                            <div class="mt-1 flex items-center">
                                <span class="inline-block h-12 w-12 overflow-hidden bg-gray-100 rounded-full">
                                    <img src="<?= base_url("/img/$wakil->image"); ?>" alt="" class="h-full w-full object-cover rounded-full">
                                </span>
    ...
    <div class="flex items-center justify-center min-h-screen py-4 px-4 text-center sm:block sm:p-0">
        ...
        <div class="inline-block align-bottom bg-white rounded-lg text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-lg w-full">
            ...
            <div class="bg-gray-50 px-4 py-3 sm:px-6 sm:flex sm:flex-row-reverse">
                <form action="<?= base_url('/candidatescontroller/deletewakil/' . $wakil->id_wakil); ?>">
